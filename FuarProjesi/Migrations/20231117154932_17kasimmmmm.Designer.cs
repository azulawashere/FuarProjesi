...
namespace FuarProjesi.Migrations
{
    ...
    [Migration("20231117154932_17kasimmmmm")]
    partial class _17kasimmmmm
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FuarProjesi.Models.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 11, 17, 15, 49, 32, 784, DateTimeKind.Utc).AddTicks(1883),
                            Name = "Admin",
                            Status = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 11, 17, 15, 49, 32, 784, DateTimeKind.Utc).AddTicks(1885),
                            Name = "Member",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("FuarProjesi.Models.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Admin = false,
                            ConcurrencyStamp = "f6173252-78cc-4cb6-a28a-3da5a701dc29",
            ...
            modelBuilder.Entity("FuarProjesi.Models.Entities.AppUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            UserId = 1,
                            CreatedDate = new DateTime(2023, 11, 17, 15, 49, 32, 784, DateTimeKind.Utc).AddTicks(1887),
                            Status = 1
                        });
                });
